...
class ExampleServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamNumbers = channel.unary_stream(
                '/example.ExampleService/StreamNumbers',
                request_serializer=example__pb2.NumberRequest.SerializeToString,
                response_deserializer=example__pb2.NumberResponse.FromString,
                _registered_method=True)
...
def add_ExampleServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'StreamNumbers': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=example__pb2.NumberResponse.SerializeToString,
            ),
    }
...
class ExampleService(object):
    ...
    def StreamNumbers(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            example__pb2.NumberResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
